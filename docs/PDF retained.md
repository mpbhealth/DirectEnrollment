...
This document describes the exact pattern used in this repo (Direct Enrollment) so you can copy it into other repos that should only retain PDFs on confirmed enrollment success.
