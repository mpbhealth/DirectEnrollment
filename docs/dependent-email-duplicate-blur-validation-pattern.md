...
**Direct Enrollment (this repo):** `src/utils/dependentEmailValidation.ts`, `src/components/DependentsAddressSection.tsx` (blur + `localErrors` merge), `src/components/EnrollmentWizard.tsx` (submit validation).
